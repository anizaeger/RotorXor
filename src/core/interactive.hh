...
namespace RotorXor
{
	int doMainMenu( int );							///< Process Main Menu
	int doConfMenu( int );							///< Process Configuration Menu
	int doKeyMenu( int );							///< Process Key Management Menu
	int doCipherMenu( int );						///< Process Cipher Operations Menu
