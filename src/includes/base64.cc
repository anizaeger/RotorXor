 ...
 *
 * @brief Source code for base64 converter.
 *
 */
#include "base64.hh"
...
/**
 * Accepts a byte vector as input, and converts it into a base64-encoded string.
 *
 * @param inputBuffer A byte vector containing data to be encoded as base64.
 * @return Data encoded as a base64 string.
 */
std::basic_string<TCHAR>
base64Encode( std::vector< BYTE > inputBuffer )
{
...
/**
 * Accepts a base64-encoded string, and converts it into data stored in a byte
 * vector.
 *
 * @param input A string composed of base64-encoded data.
 * @return Data stored in a byte vector.
 */
std::vector< BYTE >
base64Decode( const std::basic_string< TCHAR >& input )
{
